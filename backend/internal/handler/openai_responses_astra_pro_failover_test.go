...
// 本地转发统一经过 TLS 路由入口，合成传输也必须覆盖该方法。
func (u *astraProCapturedUpstream) DoWithTLS(req *http.Request, proxy string, id int64, concurrency int, _ *tlsfingerprint.Profile) (*http.Response, error) {
