...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.PUT("/codex-ticket-import-defaults", h.Admin.Setting.UpdateCodexTicketImportDefaults)
		...
		accounts.DELETE("/codex-ticket-runs/:id", h.Admin.Setting.DeleteCodexTicketHistory)
		accounts.DELETE("/codex-ticket-runs/:id/events/:event_id", h.Admin.Setting.DeleteCodexTicketHistory)
		accounts.GET("/codex-quality-results", h.Admin.Account.ListCodexQualityResults)
		accounts.GET("/codex-quality-stats", h.Admin.Account.CodexQualityStats)
		...
		accounts.GET("/codex-quality-runs/:id", h.Admin.Account.QualityRunDetail)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.POST("/codex-ticket/proxy-test", h.Admin.Setting.TestCodexTicketProxy)
