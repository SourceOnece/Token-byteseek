...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	...
	if responseModel.Valid {
		log.ResponseModel = &responseModel.String
	}
	if channelID.Valid {
