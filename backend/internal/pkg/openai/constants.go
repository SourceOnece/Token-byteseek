...
// 来源：openai/codex 的 models.json，固定提交 121f91fd5d9d。
//
...
// CanonicalizeOpenAIModelAliasSpelling 统一供应商前缀、大小写、分隔符与常见缩写。
...
// IsGPT6SolOrLunaModelSpelling 识别新模型与本地已支持的推理档位后缀。
