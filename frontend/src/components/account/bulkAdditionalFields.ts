...
export const bulkAdditionalFields: BulkAdditionalField[] = [
  ...
  field('credentials','project_id','项目 ID','Project ID','text',{platforms:['gemini','anthropic']}),
  ...
  field('credentials','oauth_type','Gemini 授权类型','Gemini OAuth type','text',{platforms:['gemini'],types:['oauth'],options:['code_assist','google_one','ai_studio']}),
  ...
  field('credentials','location','Vertex 区域','Vertex location','text',{platforms:['gemini','anthropic'],types:['service_account']}),
  field('credentials','service_account_json','服务账号 JSON','Service account JSON','secret',{platforms:['gemini','anthropic'],types:['service_account']}),
  field('credentials','client_email','服务账号邮箱','Service account email','text',{platforms:['gemini','anthropic'],types:['service_account']}),
  ...
  field('credentials','refresh_token','Qoder 刷新令牌','Qoder refresh token','secret',{platforms:['qoder']}),
