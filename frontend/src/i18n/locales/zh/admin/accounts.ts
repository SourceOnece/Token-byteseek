...
// Accounts Management
    accounts: {
      ...
      openai: {
        ...
        codexMetadataRepairKeep: '不修改',
        codexMetadataRepairEnable: '开启',
        codexMetadataRepairDisable: '关闭',
        codexMetadataRepairBulkDesc: '仅适用于本次选择的 OpenAI OAuth / AT 账号。默认不修改；开启或关闭只更新此项，不改变自动透传、指纹收敛等配置。修改后请新建会话，真实容量过载仍可能发生。',
