...
// Channel Management
    channels: {
      ...
      form: {
        ...
        defaultMaxReasoningMultiplier: '默认 1（不额外加价）',
...
// Subscriptions Management
    subscriptions: {
      ...
      bulk: {
        ...
        groupFallback: '套餐 #{id}',
        extendHint: '正整数延长，负整数缩短，最多调整 36500 天。已过期订阅从当前时间起延长，不能缩短；到期时间须晚于该订阅的开始时间。',
        ...
        confirm: '确认执行',
        retry: '重试原操作',
        retryHint: '暂未确认操作结果。重试仅查询或继续原操作。也可关闭后重新选择相同订阅和参数重试。',
