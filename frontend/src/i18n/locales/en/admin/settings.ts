...
// Settings
    settings: {
      codexTicket: {
        ...
        signalLength: 'Signal length (bytes)', signalHint: '0 = off · Hint only; no verdict change',
        ...
        limits: '25s per attempt; 30s per automatic cycle. Manual runs follow the attempt limit, stopping on success. Auth, rate limits or cancellation may end early. No business 312 monitor.',
