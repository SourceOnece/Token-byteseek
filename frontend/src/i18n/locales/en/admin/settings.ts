...
// Settings
    settings: {
      codexTicket: {
        ...
        rotateHint: 'Switch to the next proxy only after this account/model fails to obtain a ticket matching the configured length. Stop on success; collect again near expiry.',
