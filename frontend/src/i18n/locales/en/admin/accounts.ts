...
// Accounts
    accounts: {
      ...
      openai: {
        ...
        codexMetadataRepairKeep: 'Keep unchanged',
        codexMetadataRepairEnable: 'Enable',
        codexMetadataRepairDisable: 'Disable',
        codexMetadataRepairBulkDesc: 'Applies only to the selected OpenAI OAuth / AT accounts. Keeps existing values by default. Enable or disable changes only this setting, not passthrough or fingerprint convergence. Start a new session afterward; actual upstream overload may still occur.',
