...
// Channel Management
    channels: {
      ...
      form: {
        ...
        defaultMaxReasoningMultiplier: 'Default 1 (no extra charge)',
...
// Subscriptions
    subscriptions: {
      ...
      bulk: {
        adjustDays: 'Days to add or subtract',
        ...
        groupFallback: 'Plan #{id}',
        extendHint: 'Enter a positive whole number to extend or a negative one to shorten, up to 36500 days. Expired subscriptions are extended from now and cannot be shortened. The new expiration must be later than the subscription start.',
        ...
        retryHint: 'The outcome is not yet confirmed. Retrying reuses the original operation key. You can also close this dialog, then select the same subscriptions and settings to retry.',
