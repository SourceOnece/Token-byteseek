    ...
    >
      ...
      >
        ...
        <div
          ...
          class="bh-policy-section mt-4 p-4"
        ...
        >
          ...
          <div class="flex items-center justify-between">
            ...
            <button
              ...
              class="bh-switch relative inline-flex h-7 w-14 flex-shrink-0 cursor-pointer transition-all duration-150 ease-out focus:outline-none"
              :class="createForm.force_openai_fast ? 'group-switch-active' : 'bg-gray-300 dark:bg-dark-600'"
            >
              <span
                class="bh-switch-thumb pointer-events-none inline-block h-5 w-5 transform bg-white ring-0 transition duration-150 ease-out"
                :class="createForm.force_openai_fast ? 'translate-x-7' : 'translate-x-1'"
              />
            </button>
          </div>
          ...
          <div class="mt-4 flex items-center justify-between">
            ...
            >
              <span
                class="bh-switch-thumb pointer-events-none inline-block h-5 w-5 transform bg-white ring-0 transition duration-150 ease-out"
                :class="createForm.free_openai_fast ? 'translate-x-7' : 'translate-x-1'"
              />
            </button>
          </div>
          <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
        ...
        >
          ...
          <div class="flex items-center justify-between">
            ...
            >
              <span
                class="bh-switch-thumb pointer-events-none inline-block h-5 w-5 transform bg-white ring-0 transition duration-150 ease-out"
                :class="editForm.force_openai_fast ? 'translate-x-7' : 'translate-x-1'"
              />
            </button>
          </div>
          <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
          ...
          <div class="mt-4 flex items-center justify-between">
            ...
            >
              <span
                class="bh-switch-thumb pointer-events-none inline-block h-5 w-5 transform bg-white ring-0 transition duration-150 ease-out"
                :class="editForm.free_openai_fast ? 'translate-x-7' : 'translate-x-1'"
              />
            </button>
          </div>
          <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
