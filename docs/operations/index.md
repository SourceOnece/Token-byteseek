...
- [Codex号池逻辑流程图与操作手册](codex_pool_operator_guide.md)：说明调度、检测、票据、代理、双链路、模板、批量及双上游发布；包含bh.057配置归属收拢/默认值布局、成功IP复用、统一保存及实际长度筛选。读取时机：配置号池、理解功能联动、核对新增账号/筛选/批量行为、升级或交接管理员时。
