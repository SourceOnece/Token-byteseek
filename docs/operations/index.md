...
- [Codex号池逻辑流程图与操作手册](codex_pool_operator_guide.md)：说明调度、检测、票据、代理、双链路、模板、批量及双上游发布；包含bh.055工作台折叠/统一保存和bh.054实际长度自动筛选，区分验证与未测范围。读取时机：配置号池、理解功能联动、核对新增账号/筛选/批量行为、升级或交接管理员时。
