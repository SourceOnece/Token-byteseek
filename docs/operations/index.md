...
- [Codex号池逻辑流程图与操作手册](codex_pool_operator_guide.md)：说明调度、题目/定时检测、票据、代理、双链路、模板、批量编辑及双上游发布；批量界面按bh.053收敛，区分已修问题、验证证据与未测范围。读取时机：配置号池、理解功能联动、核对新增账号/批量行为、升级或交接管理员时。
