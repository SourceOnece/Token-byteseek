...
> 采集判定沿原逻辑；**bh.056**新增可选成功IP复用和两阶段长度颜色，保留bh.055工作台折叠/统一保存，核对日期：2026-09-20（Asia/Taipei）。发布状态见[bh.056记录](versions/v0_1_278_bh_056.md)，此前流程图整理见[bh.052记录](versions/v0_1_278_bh_052.md)。本文没有替你开启任何配置。
>
